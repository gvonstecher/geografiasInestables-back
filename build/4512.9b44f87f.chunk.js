(self.webpackChunkback=self.webpackChunkback||[]).push([[4512],{3108:(R,l,n)=>{/*!
...
`;l.FieldLabel=P},83534:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(58674),E=n(64919),u=n(30969),g=n(92298),i=n(73582),a=n(44158),c=n(70072);l.Field=d.Field,l.FieldLabel=E.FieldLabel,l.FieldInput=u.FieldInput,l.InputWrapper=u.InputWrapper,l.FieldHint=g.FieldHint,l.FieldError=i.FieldError,l.FieldContext=a.FieldContext,l.useField=a.useField,l.FieldAction=c.FieldAction},29382:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(85893),E=n(67294),u=n(88972),g=n(60468),i=n(90291),c=(k=>k&&k.__esModule?k:{default:k})(u),h={size:!0,spacing:!0},p=c.default(i.Flex).withConfig({shouldForwardProp:(k,w)=>!h[k]&&w(k)})`
  & > * {
    margin-top: 0;
    margin-bottom: 0;
  }
...
`,P=E.forwardRef(({horizontal:k=!1,spacing:w,size:f,...j},U)=>(f&&console.warn('Deprecation warning: Usage of "size" prop in Stack component is deprecated. This is discouraged and will be removed in the next major release. Please use "spacing" instead'),k?d.jsx(S,{ref:U,spacing:w||f,...j}):d.jsx(p,{direction:"column",alignItems:"stretch",ref:U,spacing:w||f,...j})));P.displayName="Stack",l.Stack=P},42919:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(29382);l.Stack=d.Stack},4583:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(88972),E=n(50933),u=n(60468),i=(h=>h&&h.__esModule?h:{default:h})(d),a={fontSize:!0,fontWeight:!0},c=i.default.span.withConfig({shouldForwardProp:(h,p)=>!a[h]&&p(h)})`
  ${E.variantStyle}
  ${E.ellipsisStyle}
...
`;l.Typography=c},24866:(R,l)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const n="alpha",d="beta",E="delta",u="epsilon",g="omega",i="pi",a="sigma",c=[n,d,E,u,g,i,a];l.ALPHA=n,l.BETA=d,l.DELTA=E,l.EPSILON=u,l.OMEGA=g,l.PI=i,l.SIGMA=a,l.TEXT_VARIANTS=c},50933:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(24866),E=({ellipsis:g=!1})=>g&&`
    display: block;
    white-space: nowrap;
    overflow: hidden;
  ...
  `,u=({variant:g=d.OMEGA,theme:i})=>{switch(g){case d.ALPHA:return`
      ...
      `;default:return`
        font-size: ${i.fontSizes[2]};
      `}};l.ellipsisStyle=E,l.variantStyle=u},98365:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(88972),g=(i=>i&&i.__esModule?i:{default:i})(d).default.div`
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
  ...
  position: absolute;
  width: 1px;
`;l.VisuallyHidden=g},52075:(R,l)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const n="[@strapi/design-system]:",d=E=>{const u=E;let g=!1;if(typeof u!="function")throw new TypeError(`${n} once requires a function parameter`);return(...i)=>{g||(u(...i),g=!0)}};l.PREFIX=n,l.once=d},52423:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(67294),g=(c=>c&&c.__esModule?c:{default:c})(d).default["useId".toString()]||(()=>{});let i=0;const a=c=>{const[h,p]=d.useState(g());return d.useLayoutEffect(()=>{c||p(S=>S??String(i++))},[c]),c?.toString()??(h||"")};l.useId=a},69186:(R,l,n)=>{"use strict";Object.defineProperty(l,Symbol.toStringTag,{value:"Module"});const d=n(88972),E=i=>({theme:a,size:c})=>a.sizes[i][c],u=(i="&")=>({theme:a,hasError:c=!1})=>d.css`
    outline: none;
    box-shadow: 0;
